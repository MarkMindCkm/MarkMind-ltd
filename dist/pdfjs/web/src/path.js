...
function insertMissingPoints(points, maxThreshold) {
...
function addPointToPath(path, newPoint) {
...
function applyTransformationMatrixToInkPosition(matrix, position) {
...
function eraseInk(circleCenterX, circleCenterY, circleWidth, annotations) {
...
function getAnnotationBox(position) {
	//var box = null;
	if (position.rects) {
